...
import {fetchPostsTreading} from '../../redux/PostReducer';
...
class TelasTrending extends Component{
    constructor(props){
        super(props);
...
const mapStateToProps=(state)=>{
    return {
        posts:state.postReducer.postTrending
    };
}

const mapDispatchToProps=(dispatch)=>{
    return bindActionCreators({fetchPostsTreading},dispatch);
}

export default connect(mapStateToProps,mapDispatchToProps)(TelasTrending);