...
import { returnDay, returnDateFormat, returnHoraFormat,calcdiffdates,returnRoutesOfStacks } from '../../../funcoes/geralFunctions';
        ...
        return(
            <View style={postStyle.containerPost}>
                <View style={postStyle.headerPost}>
                    <View style={postStyle.containerDescricaoDiaPost}>
                        <Text style={[historicoStyle.txtDay]}>{returnDay(this.state.post.datahorapost)}</Text>
                    </View>
                ...
                <View style={{flexDirection:'row'}}>
                    <View style={postStyle.containerDescricaoDiaPost}>
                        <View style={historicoStyle.lineDay}></View>
                    </View>
                            ...
                            <View style={postStyle.lineButtons}>
                                <View style={[styleGeral.contBtnRippleIcon,{marginRight:5}]}>
                                    <Ripple onPress={async ()=>{
                                        ...
                                        <MaterialIcons style={{color:this.state.issave?fist_color:"black"}} name="turned-in-not" size={24} color='black' />
                                    </Ripple>
                                </View>
                                <View style={[styleGeral.contBtnRippleIcon,{marginRight:5}]}>
...
export default withNavigation(connect(mapStateToProps,mapDispatchToProps)(PostPerfil));